export const viewScore = ({ correctAnswers, points }) => {
    ...
    // bonusTimeParagraph.innerHTML = `<span class="greenHighlight">${time}</span> bonus time points`; Bonusowe punkty nie czas!
